  ...
  <div id="app">
    ...
    <el-form :inline="true" :model="search" class="demo-form-inline">
      <el-form-item label="姓名">
        <el-input v-model="search.name" placeholder="查询姓名关键子"></el-input>
      </el-form-item>
      <el-form-item label="地址">
        <el-input v-model="search.address" placeholder="查询地址关键字"></el-input>
      </el-form-item>
      <el-form-item>
    ...
    <el-table :data="tableData" border style="width: 100%;">
      ...
      <el-table-column label="性别" width="120">
        ...
        <template slot-scope="scope">
          ...
          <span style="margin-left: 10px" v-if="scope.row.sex == 2">保密</span>
        </template>
      </el-table-column>
      <el-table-column prop="address" label="地址" width="120"></el-table-column>
      <el-table-column prop="age" label="年龄" width="120"></el-table-column>
      <el-table-column prop="birthday" label="生日" width="300"></el-table-column>
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          ...
          <el-button @click="editCustomer(scope.row)" type="text" size="small">编辑</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 分页组件 -->
    ...
    >
      <el-form ref="customer" :model="customer" label-width="80px">
        ...
        <el-form-item label="生日">
          <el-date-picker v-model="customer.birthday" type="date" placeholder="选择生日" value-format="yyyy-MM-dd"></el-date-picker>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      this.$axios
      .get("/api/api/getAllUser", {
          //params 一定不能省略（get），这是get请求用于封装参数的对象
         params: query
        })
        .then(res => {
          //当前页数据
